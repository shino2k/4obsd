...
# installing app set
sudo pkg_add arandr audacity cmixer compton dia filezilla firefox-esr fvwm2 gcc gimp gmrun \
...
obfs4proxy p5-XML-Parser putty-gui py3-pip qbittorrent qemu qtstyleplugins slim \
